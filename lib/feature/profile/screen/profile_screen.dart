  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Obx(
            () => controller.subscriptionPlan.value == 'Premium'
                ? SizedBox.shrink()
                : TextButton(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child:user.aboutMe.isNotEmpty ? Text(
                      user.aboutMe,
                      style: const TextStyle(
                    ...
                    ) : Text('Write Something',style: TextStyle(color: Colors.grey),),
                  ),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: user.about.entries.map((e) {
                      return Container(
                        width: double.maxFinite,
